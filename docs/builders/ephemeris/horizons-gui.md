...
Since version 0.18.0 of OpenSpace there is a new feature that allows our users to access Horizons data directly via OpenSpace with no need to go to the [Horizons website](https://ssd.jpl.nasa.gov/horizons.cgi). This feature can be found in the OpenSpace launcher by pressing a series of buttons:
...
# The Horizons Tool
In the new window there is a few places where you can input specifications for what Horizons data you want to access. Once you have put in the input you can press the *Save* button at the bottom of the window. At this point OpenSpace will ask the Horizons service for the data you want and download it and store it on your computer. This wiki will go through every step of this process and explain what each field in the window means. This process is very similar to how you would do it on the Horizons web page that you can read more about [here](horizons-web).
