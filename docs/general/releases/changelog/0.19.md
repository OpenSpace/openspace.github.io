...
## Fixes to Existing Assets
 ...
 - Add the ability to render an eclipse cone for the Earth/Moon system (#2816)
 ...
 - Add new Lua function that resets the camera back to the start position (#2825)
 - Fix issue with fisheye configurations created through the window configurator (#2818)
 - Add new Lua function to remove all loaded assets (#2812)
